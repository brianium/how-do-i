...
var loop = _.flow(speech.create, speech.streamable, _.partialRight(speech.listen, "result", console.log.bind(console)), speech.start);

loop();

},{"./speech":2,"lodash":3}],2:[function(require,module,exports){
"use strict";
